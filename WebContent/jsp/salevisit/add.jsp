					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>拜访时间：</td>
								<td>
								<INPUT class=textbox id=visit_time style="WIDTH: 180px" maxLength=50 name="visit_time">
							...
							<TR>
								<td>拜访详情 ：</td>
								<td>
								<INPUT class=textbox id=sChannel2 style="WIDTH: 180px" maxLength=50 name="visit_detail">
								</td>
								<td>下次拜访时间 ：</td>
								<td>
									<INPUT class=textbox id=visit_nexttime style="WIDTH: 180px" maxLength=50 name="visit_nexttime">
